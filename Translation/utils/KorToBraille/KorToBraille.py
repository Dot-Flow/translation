...
from .JaMoOneself import translateJaMo
...
class KorToBraille:
    ...
    def korTranslate(self, input: str):
        ...
        for word in components:
            ...
            word_translatedNumber = translateJaMo(word)  # (1) 자모음 단독 번역
            word_translatedNumber = translateNumber(word_translatedNumber)  # (2) 숫자번역
            word_translatedNumber = translatePunc(word_translatedNumber)  # (3) 문장부호 번역
            result += self.korWordToBraille(word_translatedNumber)  # (4) 한글번역
